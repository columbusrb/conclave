...
ActiveRecord::Schema.define(:version => 20130115152428) do
  ...
  add_index "pages", ["placement"], :name => "index_pages_on_placement"
  ...
  add_index "ranks", ["comment_threshold"], :name => "index_ranks_on_comment_threshold"
